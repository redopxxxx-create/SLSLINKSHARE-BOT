...
class Bot(Client):
    def __init__(self):
        super().__init__(
            ...
            api_hash=API_HASH, # Humne ise config se connect rakha hai
            api_id=APP_ID,
    ...
    async def start(self, *args, **kwargs):
        ...
        # Notify owner (Original Logic)
        try:
            await self.send_message(
                chat_id=OWNER_ID, # Config se direct owner id
